(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/router'), require('@angular/common'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@bcodes/ngx-routerlink-delay', ['exports', '@angular/core', '@angular/router', '@angular/common', 'rxjs'], factory) :
    (factory((global.bcodes = global.bcodes || {}, global.bcodes['ngx-routerlink-delay'] = {}),global.ng.core,global.ng.router,global.ng.common,global.rxjs));
}(this, (function (exports,core,router,common,rxjs) { 'use strict';
