...
import { TablaEmpleadosService } from '../service/tabla-empleados.service';
...
export class TablaEmpleadosComponent implements OnInit {
  ...
  constructor(
    private tablaEmpleadosService: TablaEmpleadosService,
  ...
  listaEmpleados(): void {
    this.tablaEmpleadosService.empleados().subscribe(
      data => {
        this.empleados = data;
